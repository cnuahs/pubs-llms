...
[1] W. K. Bleeker, A. J. C. MacKay, M. Masson- Pevet, L. N. Bouman, and A. E. Becker, "Functional and morphological organisation of the rabbit sinus node," Circ. Res., vol. 46, pp. 11- 22, 1980.  
[2] M. A. Masson- Pevet, W. K. Blecker, E. Besselsen, B. W. Treytel, H. J. Jongsma, and L. N. Bouman, "Pacemaker cell types in the rabbit sinus node: a correlative ultrastructural and electrophysiological study," J. Mol. Cell. Cardiol., vol. 16, pp. 53- 63, 1984.  
...
[4] H. Honjo, M. R. Boyett, I. Kodama, and J. Toyama, "Correlation between electrical activity and the size of rabbit sino- atrial node cells," J. Physiol., vol. 496, pp. 795- 808, 1996.  
[5] M. R. Boyett, H. Honjo, M. Yamamoto, M. R. Nikmaram, R. Niwa, and I. Kodama, "Downward gradient in action potential duration along the conduction pathway in and around the sinoatrial node," Am. J. Physiol., vol. 276, pp. H686- H698, 1999.  
[6] L. N. Bouman, E. D. Gerlings, P. A. Biortsker, and F. I. M. Bonke, "Pacemaker shift in the sino- atrial node during vagal stimulation," Pflugers Arch., vol. 302, pp. 255- 267, 1968.  
[7] M. R. Boyett, H. Honjo, and I. Kodama, "The sinoatrial node, a heterogeneous pacemaker structure," Cardiovasc. Res., vol. 47, pp. 658- 87, 2000.  
[8] W. K. Blecker, A. J. C. MacKay, M. A. Masson- Pevet, T. Op'tHof, H. J. Jongsma, and L. N. Bouman, "Asymmetry of the sino- atrial conduction in the rabbit heart," J. Mol. Cell. Cardiol., vol. 14, pp. 633- 43, 1982.  
[9] E. E. Verheijck, A. Wessels, A. C. G. van Ginneken, J. Bourier, M. W. M. Markman, J. L. M. Vermeulen, J. M. T. de Makker, W. H. Lamers, T. Opthof, and L. N. Bouman, "Distribution of atrial and nodal cells within the rabbit sinoatrial node," Circulation, vol. 97, pp. 1623- 1631, 1998.  
[10] D. C. Michaels, E. P. Matyas, and J. Jalife, "Mechanisms of sinoatrial pacemaker synchronization: A new hypothesis," Circ. Res., vol. 61, pp. 704- 714, 1987.  
[11] D. Cai, R. L. Winslow, and D. Noble, "Effects of gap junction conductance on dynamics of sinoatrial node cells: two- cell and large- scale network models," IEEE Trans. Biomed. Eng., vol. 41, pp. 217- 231, 1994.  
[12] R. L. Winslow, A. Kimball, A. Varghese, and D. Noble, "Simulating cardiac sinus and atrial network dynamics on the connection machine," Physica. D, vol. 64, pp. 281- 298, 1993.  
[13] G. Sands, "Mathematical model of ventricular activation in an anatomically accurate deforming heart," Ph.D. Thesis, University of Auckland, 1996.  
[14] S. Dokos, B. G. Celler, and N. H. Lovell, "Vagal control of sinoatrial rhythm: a mathematical model," J. Theor. Biol., vol. 182, pp. 214- 194, 1996.  
...
[16] S. L. Cloherty, N. H. Lovell, B. G. Celler, and S. Dokos, "Inhomogeneity of action potential waveshape assists frequency entrainment of cardiac pacemaker cells," IEEE Trans. Biomed. Eng., in Press.  
[17] Y. E. Earm and D. Noble, "A model of the single atrial cell: relation between calcium current and calcium release," Proc. R. Soc. Lond. B, vol. 240, pp. 83- 96, 1990.  
[18] M. Lutz, Programming Python: O'Reilly & Associates, 1996.  
[19] S. Cohen and A. Hindmarsh, "CVODE, a stiff/nonstiff ODE solver in C," Computers in Physics, vol. 10, pp. 138- 43, 1996.  
[20] W. Gropp, E. Lusk, N. Doss, and A. Skjellum, "A high- performance, portable implementation of the (MPI) message passing interface standard," Parallel Computing, vol. 22, pp. 789- 828, 1996.
