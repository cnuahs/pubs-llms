...
We would like to thank Dr. Socrates Dokos and Dr. Nigel Lovell for their guidance.

## REFERENCES

[1] P. J. Hunter and T. K. Borg, "Integration from proteins to organs: The Physiome Project," Nature Reviews, vol. 4, pp. 237- 243, March 2003.  
[2] G. Tsafnat, S.L. Cloherty, and T. Lambert, "Vision: A visualisation language and toolkit," in The Second IASTED International Conference on Biomedical Engineering, February 2004.  
[3] L. Guibas and J. Stolfi, "Primitives for the manipulation of general subdivisions and the computation of Voronoi diagrams," ACM Transactions on Graphics, vol. 4, no. 2, pp. 74- 123, April 1985.  
[4] C. M. Lloyd, M. D. B. Halstead, and P. Nielsen, "CellML: Its future, present and past," Progress in Biophysics and Molecular Biology, 2004, In Press.  
[5] G. Tsafnat, "The DDF library Web Site," http://visione.sourceforge.net/ddf/, 2004.  
[6] IUPPS Physiome, "The Physiome Project Web Site," http://www.physiome.org.nz, 2003.  
[7] K. Martin, W. Schroeder, and Bill Lorensen, The Visualization Toolkit—An Object-Oriented Approach To 3D Graphics, Kitware, Inc., 3rd edition, 2003.  
[8] G. Abram, N. Collins, P.D. Kirchner, K. Sams, D. Gresh, T. Elvins, B. Hollebeek, C. Pelkie, D. Thompson, J. Braun, M. Zeleznik, L. Treinish, S. Siddiqi, R. Scott, and R. Hopper, "Open visualisation data explorer," http://www.opendx.com, 2003.  
[9] S.L. Cloherty, N.H. Lovell, S. Dokos, and B.G. Celler, "A 2D monodomain model of rabbit sinoatrial node," in 23rd Annual Conference of the IEEE Engineering in Medicine and Biology Society, 2001.  
[10] G. Tsafnat, S.L. Cloherty, and T. Lambert, "Visualisation of dynamic computational models of cardiac tissue," in World Congress on Medical Physics and Biomedical Engineering, August 2003.  
[11] N. Tsafnat, G. Tsafnat, and T.D. Lambert, "A three- dimensional fractal model of tumour vasculature," in 26th Annual Conference of the IEEE Engineering in Medicine and Biology Society, September 2004.  
[12] N. Tsafnat and S.K. Jones, "Numerical analysis of ferromagnetic embolisation hyperthermia for liver tumour therapy," in The Second IASTED International Conference on Biomedical Engineering, February 2004.
